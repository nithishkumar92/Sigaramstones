  ...
  return (
    ...
    >
      ...
      <footer style={{ background: "#1e1a14", borderTop: "1px solid rgba(201,168,76,0.25)", padding: "52px 40px", textAlign: "center", marginTop: 60 }}>
        ...
        <p style={{ fontFamily: "'Jost',sans-serif", fontSize: "0.68rem", color: "rgba(200,196,188,0.35)", letterSpacing: "0.1em" }}>© 2026 Sigaram Stones, Kallimandayam, Dindigul. All rights reserved.</p>
      </footer>
    </div>
  );
}
